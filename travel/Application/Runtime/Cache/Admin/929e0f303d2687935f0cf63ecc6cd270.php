...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<link rel="stylesheet" href="/travel/Public/Admin/css/login.css" />
		<meta http-equiv="Content-Type" content="text/html;charset=utf-8">
		<script type="text/javascript" src="/travel/Public/Admin/js/jquery-1.7.2.min.js"></script>
		<script type="text/javascript" src="/travel/Public/Admin/js/login.js"></script>
		...
		<div class="login">	
			...
			<table border="1" width="100%">
				...
				<tr>
					<th>验证码:</th>
					<td>
						<input type="code" class="len250" name="code"/> <img src="<?php echo U('Admin/Login/verify');?>" id="code"/> 
