		...
		<div class="row">
			...
			<?php if(is_array($data)): foreach($data as $key=>$v): ?><div class="three columns">
					<div class="icon-hover">
						<a href="<?php echo U('Home/Note/onenote2', array('id'=>$v['id']));?>" title=""><img src="/travel/Public/images/manage/demo/thumb-<?php echo(rand(1, 14))?>.jpg" alt="" class="transparency"></a>
						<div class="underlay">
							查看
						</div>
					</div>
					...
					<div class="entry-detail">
						<h5><a href="<?php echo U('Home/Note/onenote2', array('id'=>$v['id']));?>"><?php echo ($v["title"]); ?></a></h5>
						<?php echo ($v["head"]); ?>
					</div>
				</div>
