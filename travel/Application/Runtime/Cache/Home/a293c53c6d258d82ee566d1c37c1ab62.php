		...
		<div class="services">
			<div class="wrap">
				...
				<div class="section group group">
					<div class="listview_1_of_2 images_1_of_2">
						<div class="listimg listimg_2_of_1">
							<img src="/travel/Public/images/Index/res.png">
						</div>
						<div class="text list_2_of_1">
							<h3><span>旅游</span> 攻略</h3>
							<br/>
							<p>看看再说。</p>
							<br/><br/><br/><br/>
							<a class="button" href="<?php echo U('Home/Service/raider');?>">了解更多</a>
						</div>
					</div>			
					<div class="listview_1_of_2 images_1_of_2">
						<div class="listimg listimg_2_of_1">
							<img src="/travel/Public/images/Index/guid.png">
						</div>
						<div class="text list_2_of_1">
							<h3><span>路线</span> 导航</h3>
							<!-- <h4>Sed ut perspiciatis undeaccusantium .</h4> -->
							<br/>
							<p>想去哪，就去哪！</p>
							<br/><br/><br/><br/>
							<a class="button" href="<?php echo U('Home/Service/map');?>">了解更多</a>
						</div>
					</div>
				</div>
				<div class="section group">
					<div class="listview_1_of_2 images_1_of_2">
						<div class="listimg listimg_2_of_1">
							<img src="/travel/Public/images/Index/air.png">
						</div>
						<div class="text list_2_of_1 ">
							<h3><span>航班</span> 查询</h3>
							<!-- <h4>Sed ut perspiciatis undeaccusantium .</h4> -->
							<br/>
							<p>中国的航班每一个是准时的！ </p>
							<br/><br/><br/><br/>
							<a class="button" href="<?php echo U('Home/Service/flight');?>">了解更多</a>
						</div>
					</div>			
					<div class="listview_1_of_2 images_1_of_2">
						<div class="listimg listimg_2_of_1">
							<img src="/travel/Public/images/Index/compin.png">
						</div>
						<div class="text list_2_of_1">
							<h3><span>旅游社 </span>服务</h3>
							<!-- <h4>Sed ut perspiciatis undeaccusantium .</h4> -->
							<br/>
							<p>有些时候我们也需要他人的帮助~~</p>
							<br/><br/><br/><br/>
