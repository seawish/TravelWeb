	...
	<div id="subtitle">
		...
		<div class="container">
			...
			<div class="five columns">
				<a id="submiticon" href="<?php echo U('Home/Note/index2');?>"></a>
			</div>
		</div>
		<!-- End 960 Container -->
				...
				<div class="write">
					<div class="title">
						<form name="noteform" action="<?php echo U('Home/Note/submit');?>" method="post">
							...
							<input id="titleinput" name="titlename" type="text" size="80"value="">
							<br/>
<!-- 							<label>
								<span style="color: red;">*</span>
								分类&nbsp;&nbsp;&nbsp;
					        ...
					        <input id="author" name="author" type="hidden" value="<?php echo(session('username'))?>" >
